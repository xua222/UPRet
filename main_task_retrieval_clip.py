...
from modules.modeling_clip4clip import CLIP4Clip
...
def set_seed_logger(args):
    ...
    logger = get_logger(os.path.join(args.output_dir, "ot_weight_20.txt"))
...
def eval_epoch(args, model, test_dataloader, device, n_gpu,istrain):
    ...
    #########################################
        ...
        sim_matrix_i2t = _run_on_single_gpu_new_mix(model,  batch_list_v,batch_list_t, batch_sequence_output_list, batch_visual_output_list,\
       ...
       # sim_matrix_t2i = np.stack(tuple(sim_matrix_new_t2i), axis=0)
        ...
        tv_metrics = compute_metrics(tensor_video_to_text_sim(sim_matrix_i2t.T))
